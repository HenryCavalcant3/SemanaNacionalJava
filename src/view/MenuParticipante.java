...
public class MenuParticipante extends javax.swing.JDialog {
    private Participante participante;
    
    public MenuParticipante(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        btnParticipante.setText("Perfil");
    ...
    private void btnSemanaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnSemanaMouseClicked
        SemanasParticipante semanasParticipante = new SemanasParticipante(null, rootPaneCheckingEnabled);

        this.setVisible(false);
        semanasParticipante.setParticipante(participante);
        semanasParticipante.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                MenuParticipante dialog = new MenuParticipante(new javax.swing.JFrame(), true);
